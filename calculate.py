    ...
    def checkpath(self):
        ...
        for el in systemPATH:
            if 'orca' in el or 'ORCA' in el:
                ...
                self.orcapath = el+'/orca ' # space was removed here
                self.status = 1
                break
        if self.orcapath == '':
...
Moving on!
            ...
            print(color.RED + 'Something went wrong with the ORCA calculation, please check output files in ' + os.getcwd() + color.END)
