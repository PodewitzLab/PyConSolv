...
class Faker:
    ...
    def fakeforce(self):
        ...
        self.writeout(lin_hess, 'Cartesian Force Constants                  R   N=         ' + str(int(((size+1)*size)/2)) + '\n', factor = 1)
        # return lin_hess
 ...
 **********************************************************************\n\n'''
        ...
        for i in range(len(coords)):
            pointID += 1
            f.write('       Atomic Center '+ '{:>4}'.format(pointID) + ' is at '+'{:>10.6f}'.format(float(coords[i][1]))+'{:>10.6f}'.format(float(coords[i][2]))+'{:>10.6f}\n'.format(float(coords[i][3])))
        for i in range(len(ESP_data)):
            pointID += 1
            f.write('      ESP Fit Center '+ '{:>4}'.format(pointID) + ' is at '+'{:>10.6f}'.format(float(ESP_data[i][0]))+'{:>10.6f}'.format(float(ESP_data[i][1]))+'{:>10.6f}\n'.format(float(ESP_data[i][2])))
        f.write('\n')
        f.write('''
 -----------------------------------------------------------------
