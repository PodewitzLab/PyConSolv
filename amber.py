...
frcmod_files {}.frcmod'''.format(metals, '.mol2 '.join(ligands), '.frcmod '.join(ligands))
    ...
    def antechamber(self, name, charge):
        ...
        antechamberCommand = 'antechamber -fi pdb -fo mol2 -i {}.pdb -o {}.mol2 -c bcc -pf y -nc {} > antechamber_{}.out'.format(name,name,int(float(charge)),name)
    ...
    def equil(self, path, restrained_residue = '1'):
        ...
        data = [[minheader,'restraint_wt=1000.0,restraintmask="!@H="\n/\n'],#1
                     ...
                     [nvtheader,'ntr=1,restraint_wt=1000.0,restraintmask="!@H=&:{}",\n\tnstlim=100000,nmropt=1,dt=0.001,\n/\n'.format(restrained_residue) + '&wt TYPE=\'TEMP0\', istep1=0, istep2=100000, value1=100.0,value2=300.0 /\n&wt TYPE=\'END\' /\n'],#3
                     [nptheader,'ntr=1,restraint_wt=1000.0,restraintmask="!@H=&:{}",\n\tnstlim=30000,dt=0.001,\n/\n'.format(restrained_residue)],#4s
                     [nptheader,'ntr=1,restraint_wt=1000.0,restraintmask="!@H=&:{}",\n\tnstlim=70000,dt=0.001,\n/\n'.format(restrained_residue)],#4
                     [nvtheader,'ntr=1,restraint_wt=1000.0,restraintmask="!@H=&:{}",\n\tnstlim=100000,dt=0.001,nmropt=1,\n/\n'.format(restrained_residue) + '&wt TYPE=\'TEMP0\', istep1=0, istep2=100000, value1=300.0,value2=100.0 /\n&wt TYPE=\'END\' /\n'],#5
                     [minheader,'restraint_wt={:0.1f},restraintmask="!@H=&:{}",\n/\n'.format(minseq[0],restrained_residue)],#6
